...
ZTest Always
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float2 node_6548 = ((node_2179+node_1372.r*float2(1,1)) + float2(node_6548_tx, node_6548_ty)) * node_6548_tc_rcp;
