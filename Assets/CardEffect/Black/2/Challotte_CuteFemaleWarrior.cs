...
using UnityEngine;
using System;
public class Challotte_CuteFemaleWarrior : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        powerUpByEnemy.SetUpPowerUpByEnemyWeapon("女の本性", (enemyUnit, Power) => Power + 30, (unit) => unit == card.UnitContainingThisCharacter(), (enemyUnit) => enemyUnit.Character.sex.Contains(Sex.female), PowerUpByEnemy.Mode.Attacking, card);
