...
using System;
using System.Linq;
public class Foreo_CutePrince : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            IEnumerator ActivateCoroutine()
            {
                ...
                selectCardEffect.SetUp(
                    CanTargetCondition: (cardSource) => !cardSource.UnitNames.Contains("フォレオ"),
        ...
        ChangeSexClass changeSexClass = new ChangeSexClass();
        changeSexClass.SetUpICardEffect("僕...可愛いですか?","", null, null, -1, false, card);
        changeSexClass.SetUpChangeSexClass((sex) => { sex.Add(Sex.female); return sex; });
        cardEffects.Add(changeSexClass);
