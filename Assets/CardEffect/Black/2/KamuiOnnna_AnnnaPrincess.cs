...
public class KamuiOnnna_AnnnaPrincess : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        powerUpClass.SetUpICardEffect("夜刀神・長夜", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition1 }, -1, false);
        ...
        changeCardColorsClass.SetUpICardEffect("白夜の心", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition2 }, -1, false);
