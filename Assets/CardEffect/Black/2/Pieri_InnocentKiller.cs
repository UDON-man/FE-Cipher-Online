...
public class Pieri_InnocentKiller : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDestroyedAnyone)
        {
            ...
            activateClass.SetUpICardEffect("返り血いっぱいなの!", "All I know is blood!", new List<Cost>() , null, -1, false,card);
        ...
        {
            ActivateClass activateClass = new ActivateClass();
            activateClass.SetUpICardEffect("ピエリの小槍", "Peri's Spear",new List<Cost>() { new ReverseCost(1, (cardSource) => true) }, null, -1, false, card);
            activateClass.SetUpActivateClass((hashtable) => ActivateCoroutine());
