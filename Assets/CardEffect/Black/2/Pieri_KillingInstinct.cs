...
public class Pieri_KillingInstinct : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        {
            activateClass[0].SetUpICardEffect("マークス隊のピエリ", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, false);
