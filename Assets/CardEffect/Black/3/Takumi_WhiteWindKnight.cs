...
public class Takumi_WhiteWindKnight : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        powerUpByEnemy.SetUpPowerUpByEnemyWeapon("まだまだ未熟だね", (enemyUnit, Power) => Power + 20, (unit) => unit == this.card.UnitContainingThisCharacter(), (enemyUnit) => enemyUnit.Weapons.Contains(Weapon.Bow), PowerUpByEnemy.Mode.Both);
