...
public class Takumi_WhiteWindKnight : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        powerUpByEnemy.SetUpPowerUpByEnemyWeapon("まだまだ未熟だね", (enemyUnit, Power) => Power + 20, (unit) => unit == card.UnitContainingThisCharacter(), (enemyUnit) => enemyUnit.Weapons.Contains(Weapon.Bow), PowerUpByEnemy.Mode.Both,card);
