...
using System.Linq;
using Photon.Pun;
public class Ashura_TheifLostHisName : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        powerUpByEnemy1.SetUpPowerUpByEnemyWeapon("ダーティファイト", (enemyUnit, Power) => Power + 10, (unit) => unit == card.UnitContainingThisCharacter(), (enemyUnit) => card.Owner.Enemy.GetFrontUnits().Contains(enemyUnit), PowerUpByEnemy.Mode.Attacking, card);
