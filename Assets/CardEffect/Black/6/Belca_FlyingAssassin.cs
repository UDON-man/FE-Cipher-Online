...
public class Belca_FlyingAssassin : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            activateClass.SetUpICardEffect("特効隊長", "Commander of the Kamikaze unit", new List<Cost>() { new ReverseCost(1, (cardSource) => true), new DestroySelfCost() }, new List<Func<Hashtable, bool>>(), -1, false,card);
