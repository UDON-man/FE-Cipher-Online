...
public class Garon_ProudAnnyaKing : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            activateClass.SetUpICardEffect("暗夜のカリスマ", "Royal Charisma", new List<Cost>() { selectAllyCost }, new List<Func<Hashtable, bool>>(), 1, false, card);
