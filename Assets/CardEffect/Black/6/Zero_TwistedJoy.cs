...
using Photon;
using Photon.Pun;
public class Zero_TwistedJoy : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDestroyDuringBattleAlly)
        {
            ...
            activateClass.SetUpICardEffect("暗夜の拘束術", "Kidnap",new List<Cost>() { new ReverseCost(1, (cardSource) => true) }, new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, true,card);
