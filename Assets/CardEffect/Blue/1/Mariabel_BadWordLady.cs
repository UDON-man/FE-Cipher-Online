...
public class Mariabel_BadWordLady : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            IEnumerator ActivateCoroutine()
            {
                ...
                selectCardEffect.SetUp(
                    CanTargetCondition: (cardSource) => !cardSource.UnitNames.Contains("マリアベル"),
        ...
        powerUpClass.SetUpICardEffect("令嬢の嗜み","", null, null, -1, false,card);
        ...
        bool PowerUpCondition(Unit unit)
        {
            if(unit.Character != null)
            {
                ...
                {
                    if (unit.Character.UnitNames.Contains("リズ"))
                    {
