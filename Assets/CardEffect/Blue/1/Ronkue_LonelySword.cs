...
public class Ronkue_LonelySword : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        powerUpClass.SetUpICardEffect("剣の達人", null, null, -1, false);
        powerUpClass.SetUpPowerUpClass((unit, Power) => Power + card.Owner.FieldUnit.Count((_unit) => _unit != unit && _unit.Weapons.Contains(Weapon.Sword)), (unit) => unit == card.UnitContainingThisCharacter());
