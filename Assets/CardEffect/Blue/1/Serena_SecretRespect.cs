...
public class Serena_SecretRespect : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        powerUpClass.SetUpICardEffect("裏腹な心", "",null, null, -1, false,card);
        ...
        bool CanPowerUpCondition(Unit unit)
        {
            ...
            {
                if (card.Owner.FieldUnit.Count((_unit) => _unit.Character.UnitNames.Contains("ティアモ")) > 0)
                {
                    return true;
                }
            }
