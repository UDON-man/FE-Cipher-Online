...
using UnityEngine;
using System;
public class Miriel_CleverEye : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            activateClass.SetUpICardEffect("魔道研究", "Magical Research", new List<Cost>() { new TapCost(), new DiscardHandCost(1, (cardSource) => true) }, null, -1, false,card);
