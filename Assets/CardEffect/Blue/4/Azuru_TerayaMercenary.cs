...
public class Azuru_TerayaMercenary : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDestroyDuringBattleAlly)
        {
            ...
            activateClass.SetUpICardEffect("エスコート", "Escort", new List<Cost>() , new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, true, card);
            ...
            IEnumerator ActivateCoroutine()
            {
                ...
                selectUnitEffect.SetUp(
                    ...
                    CanTargetCondition: (unit) => unit.Character.Owner == card.Owner && unit.Character.sex.Contains(Sex.female) && card.Owner.GetFrontUnits().Contains(unit),
