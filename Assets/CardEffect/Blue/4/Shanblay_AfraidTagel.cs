...
public class Shanblay_AfraidTagel : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnEndAttackAnyone)
        {
            ...
            activateClass.SetUpICardEffect("生き残る術", "Art of Survival",new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, true,card);
