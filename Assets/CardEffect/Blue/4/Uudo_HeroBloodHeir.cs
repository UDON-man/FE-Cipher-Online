...
public class Uudo_HeroBloodHeir : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        powerUpClass.SetUpICardEffect("手加減できないぜ","", null, null, -1, false,card);
        powerUpClass.SetUpPowerUpClass((unit, Power) => Power + 10, (unit) => unit == card.UnitContainingThisCharacter() && card.Owner.Enemy.HandCards.Count <= 3 && GManager.instance.turnStateMachine.gameContext.TurnPlayer == card.Owner, true);
