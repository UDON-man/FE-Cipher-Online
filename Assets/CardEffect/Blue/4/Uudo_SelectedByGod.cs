...
public class Uudo_SelectedByGod : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        powerUpClass.SetUpICardEffect("ダメだ…! 力が…暴走する…!", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, false);
        ...
        canNotAttackClass.SetUpICardEffect("ダメだ…! 力が…暴走する…!", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, false);
        ...
        canAttackTargetUnitRegardlessRangeClass.SetUpICardEffect("ダメだ…! 力が…暴走する…!", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, false);
        ...
        strikeUpClass.SetUpICardEffect("烈火剣 レイジングファイヤーソード", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition1 }, -1, false);
