...
public class Killroy_SickPriest : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            IEnumerator ActivateCoroutine()
            {
                ...
                selectCardEffect.SetUp(
                    CanTargetCondition: (cardSource) => !cardSource.UnitNames.Contains("キルロイ"),
        ...
        powerUpClass.SetUpPowerUpClass((unit, Power) => Power + 10, (unit) => unit.Character.Owner == card.Owner && unit.Character.UnitNames.Contains("ワユ"), true);
        powerUpClass.SetUpICardEffect("宿命のライバル", "",null, null, -1, false,card);
