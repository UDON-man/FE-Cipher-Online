...
public class Killroy_SickPriest : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        powerUpClass.SetUpPowerUpClass((unit, Power) => Power + 10, (unit) => unit.Character.Owner == this.card.Owner && unit.Character.UnitNames.Contains("ワユ"));
        powerUpClass.SetUpICardEffect("宿命のライバル", null, null, -1, false);
