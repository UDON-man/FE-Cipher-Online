...
public class Rai_RoughWarrior : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        powerUpByEnemy.SetUpPowerUpByEnemyWeapon("獣の眼", (enemyUnit, Power) => Power + 10, (unit) => unit == card.UnitContainingThisCharacter(), (enemyUnit) => enemyUnit.Character.Owner.GetBackUnits().Contains(enemyUnit), PowerUpByEnemy.Mode.Both,card);
