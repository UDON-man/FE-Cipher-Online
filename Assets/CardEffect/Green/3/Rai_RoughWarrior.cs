...
public class Rai_RoughWarrior : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        powerUpByEnemy.SetUpPowerUpByEnemyWeapon("獣の眼", (enemyUnit, Power) => Power + 10, (unit) => unit == this.card.UnitContainingThisCharacter(), (enemyUnit) => enemyUnit.Character.Owner.GetBackUnits().Contains(enemyUnit), PowerUpByEnemy.Mode.Both);
