...
public class Rete_DaughterBeastFang : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        canAttackTargetUnitRegardlessRangeClass.SetUpICardEffect("帝国への怒り", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, false);
        canAttackTargetUnitRegardlessRangeClass.SetUpCanAttackTargetUnitRegardlessRangeClass((AttackingUnit) => AttackingUnit == card.UnitContainingThisCharacter(), (DefendingUnit) => DefendingUnit.Weapons.Contains(Weapon.MagicBook)|| DefendingUnit.Weapons.Contains(Weapon.Rod));
