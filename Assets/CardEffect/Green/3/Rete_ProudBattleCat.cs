...
public class Rete_ProudBattleCat : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        canNotSupportClass.SetUpCanNotSupportClass((cardSource) => !cardSource.Weapons.Contains(Weapon.Beast) , (unit) => unit == this.card.UnitContainingThisCharacter());
        canNotSupportClass.SetUpICardEffect("ベオク嫌い", null, null, -1, false);
