...
public class Tsuihaku_WanderingSwordman : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnAttackAnyone)
        {
            ...
            activateClass.SetUpICardEffect("ラグズの護り手", "Defender of Laguz", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, false,card);
