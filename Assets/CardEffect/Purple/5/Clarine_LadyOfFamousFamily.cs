...
using System;
using System.Linq;
public class Clarine_LadyOfFamousFamily : CEntity_Effect
{
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            IEnumerator ActivateCoroutine()
            {
                ...
                selectCardEffect.SetUp(
                    CanTargetCondition: (cardSource) => !cardSource.UnitNames.Contains("クラリーネ"),
    ...
    public override List<ICardEffect> SupportEffects(EffectTiming timing)
    {
        ...
        if (timing == EffectTiming.OnSetSupport)
        {
            ...
            canNotCriticalClass.SetUpICardEffect("祈りの紋章", null, new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, false);
            supportEffects.Add(canNotCriticalClass);
