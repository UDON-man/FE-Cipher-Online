...
using System;
using System.Linq;
public class Shany_FriedlyPegsusKnight : CEntity_Effect
{
    ...
    public override List<ICardEffect> SupportEffects(EffectTiming timing)
    {
        ...
        {
            activateClass_Support[0].SetUpICardEffect("天馬の号令", new List<Cost>() { new ReverseCost(1, (cardSource) => true) }, new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, true);
            activateClass_Support[0].SetUpActivateClass((hashtable) => ActivateCoroutine());
            supportEffects.Add(activateClass_Support[0]);

            if (ContinuousController.instance.language == Language.ENG)
            {
                activateClass_Support[0].EffectName = "Way of the Pegasus";
            }
