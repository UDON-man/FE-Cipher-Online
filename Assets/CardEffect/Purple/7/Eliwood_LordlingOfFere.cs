...
using UnityEngine;
using System;
public class Eliwood_LordlingOfFere : CEntity_Effect
{
    #region 勇気の紋章
    public override List<ICardEffect> SupportEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnSetSupport)
        {
            ...
            activateClass_Support.SetUpICardEffect("勇気の紋章", "Courage Emblem", null, new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, false, card);
