...
public class Maria_SisterPricessOfMakedonia : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            IEnumerator ActivateCoroutine()
            {
                ...
                selectCardEffect.SetUp(
                    CanTargetCondition: (cardSource) => !cardSource.UnitNames.Contains("マリア"),
        ...
        powerUpClass.SetUpPowerUpClass((unit, Power) => Power + 10, (unit) => unit.Character.Owner == card.Owner && (unit.Character.UnitNames.Contains("ミネルバ")|| unit.Character.UnitNames.Contains("ミシェイル")), true);
        powerUpClass.SetUpICardEffect("マリアの想い","", null, null, -1, false,card);
