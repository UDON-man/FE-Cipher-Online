...
public class Maria_SisterPricessOfMakedonia : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        powerUpClass.SetUpPowerUpClass((unit, Power) => Power + 10, (unit) => unit.Character.Owner == this.card.Owner && (unit.Character.UnitNames.Contains("ミネルバ")|| unit.Character.UnitNames.Contains("ミシェイル")));
        powerUpClass.SetUpICardEffect("マリアの想い", null, null, -1, false);
