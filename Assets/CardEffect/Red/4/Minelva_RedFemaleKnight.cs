...
using System;
using System.Linq;
public class Minelva_RedFemaleKnight : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        powerUpClass.SetUpICardEffect("マケドニアの剣","", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition1 }, -1, false,card);
        ...
        bool CanUseCondition1(Hashtable hashtable)
        {
            ...
            {
                if (card.Owner.FieldUnit.Count((_unit) => _unit.Weapons.Contains(Weapon.Wing)) >= 2)
                {
                    return true;
                }
            }
