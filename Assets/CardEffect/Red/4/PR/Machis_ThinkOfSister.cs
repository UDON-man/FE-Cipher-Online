...
public class Machis_ThinkOfSister : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        powerUpByEnemy.SetUpICardEffect("妹は渡さん!", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, false);
        powerUpByEnemy.SetUpPowerUpByEnemyWeapon("妹は渡さん!", (enemyUnit, Power) => Power + 20, (unit) => unit == this.card.UnitContainingThisCharacter(), (enemyUnit) => enemyUnit.Character.UnitNames.Contains("ジュリアン"), PowerUpByEnemy.Mode.Attacking);
