...
public class Yumina_GuruniaPrincess : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        powerUpClass.SetUpPowerUpClass((unit, Power) => Power + 10, (unit) => unit.Character.Owner == this.card.Owner && (unit == card.UnitContainingThisCharacter() || unit.Character.UnitNames.Contains("ユベロ")));
        powerUpClass.SetUpICardEffect("双子の絆", null, new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, false);
