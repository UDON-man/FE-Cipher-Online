...
using System;
using System.Linq;
public class Oboro_AngryLancer : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing)
    {
        ...
        {
            activateClass[0].SetUpICardEffect("タクミ隊のオボロ", new List<Cost>(), new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, true);
