...
public class Ayra_PrincessOfIsaach : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnUnTappedAnyone)
        {
            ...
            activateClass.SetUpICardEffect("刃の高鳴り", "Blade's Pulse", new List<Cost>() , new List<Func<Hashtable, bool>>() { CanUseCondition }, -1, false,card);
