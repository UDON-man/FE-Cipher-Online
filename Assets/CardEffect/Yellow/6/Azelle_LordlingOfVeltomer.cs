...
public class Azelle_LordlingOfVeltomer : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            activateClass.SetUpICardEffect("焔の叡智", "Wisdom of the Flame", new List<Cost>() { new ReverseSelfCost() }, null, -1, false,card);
