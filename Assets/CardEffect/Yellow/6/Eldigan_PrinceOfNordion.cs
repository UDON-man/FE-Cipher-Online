...
public class Eldigan_PrinceOfNordion : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            activateClass.SetUpICardEffect("ノディオンの剣技", "Nordion's Command", new List<Cost>() { new DiscardHandCost(1, (cardSource) => true) }, null, 1, false,card);
