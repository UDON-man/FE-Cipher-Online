...
using System;
using System.Linq;
public class Ema_FreshPegasus : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            activateClass.SetUpICardEffect("天空の絆", "Bonds of the Sky", new List<Cost>() { new ReverseSelfCost() }, null, -1, false,card);
            ...
            IEnumerator ActivateCoroutine()
            {
                ...
                selectUnitEffect.SetUp(
                    ...
                    CanTargetCondition: (unit) => unit.Character.Owner == card.Owner && (!unit.Character.UnitNames.Contains("エマ")),
