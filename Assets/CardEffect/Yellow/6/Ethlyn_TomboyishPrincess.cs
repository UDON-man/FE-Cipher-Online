...
using UnityEngine;
using System;
public class Ethlyn_TomboyishPrincess : CEntity_Effect
{
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            IEnumerator ActivateCoroutine()
            {
                ...
                selectCardEffect.SetUp(
                    CanTargetCondition: (cardSource) => !cardSource.UnitNames.Contains("エスリン"),
            ...
            activateClass1.SetUpICardEffect("細身の剣", "Slim Sword", new List<Cost>() { new ReverseCost(1, (cardSource) => true) }, null, 1, false,card);
            ...
            IEnumerator ActivateCoroutine1()
            {
                ...
                weaponChangeClass.SetUpWeaponChangeClass((CardSource, Weapons) => { Weapons.Add(Weapon.Sword); return Weapons; }, CanWeaponChangeCondition);
