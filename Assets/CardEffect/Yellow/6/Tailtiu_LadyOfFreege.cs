...
public class Tailtiu_LadyOfFreege : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnDeclaration)
        {
            ...
            activateClass.SetUpICardEffect("雷の才能", "Thunder Talent",new List<Cost>() { new ReverseCost(1, (cardSource) => true) }, null, 1, false,card);
